...
const Login = (props) => {
    ...
    return(
        <View style={styles.screen}> 
            ...
            <Image style={styles.logo} source={require('../assets/images/Educatology2.png')}/>
            ...
            <TouchableOpacity style={[styles.signup,{backgroundColor : agree ? '#67ADFF' : 'grey'}]}
             ...
             onPress={() => {props.navigation.replace('mydrawer',{
                ...
                pass:Password
                    ...
                    <Text style={{fontSize:18,color:'white',fontWeight:600,alignSelf:'center',}}> Sign In</Text>

            </TouchableOpacity>


            <Text style={{fontSize:18,fontWeight:500,color:'grey',marginTop:50,alignSelf:'center'}}> Don’t You Have Account ? </Text>
            
            <TouchableOpacity 
            onPress={() => { props.navigation.navigate('signup')}}>
                <Text style={{fontSize:14,fontWeight:500,color:'#67ADFF',marginTop:20,alignSelf:'center'}}> Sign Up </Text>
            </TouchableOpacity>
