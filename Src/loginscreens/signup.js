...
const Signup = ({navigation}) => {
    ...
    return(
        <View style={styles.screen}> 
            ...
            <Text style={{fontSize:18,fontWeight:500,color:'#8AC0FF',marginTop:50,alignSelf:'center'}}> Create Account </Text>
        ...
        <Text style={{fontSize:18,fontWeight:500,color:'grey',marginTop:50,alignSelf:'center'}}> Already have an account ? </Text>
